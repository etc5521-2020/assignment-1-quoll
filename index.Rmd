...
mission_hrs <- astronauts %>%
  ...
  xlab("") +
  theme_minimal() +
  # assign theme with no grid lines in the plot
  theme(
...
```{r astro-15, out.width="100%", out.height="60%"}
# combined the plots side by side
plot_mission+plot_eva+plot_layout(guides = "collect", heights = 100)
```

Peggy A. Whitson and Sunita L. Williams in Figure \@ref(fig:whitson-sunita), are American astronauts. Reporting from @mars_peggy_2015, "Peggy completed two six-month tours of duty aboard the station for Expedition 5 in 2002, and as the station commander for Expedition 16 in 2008 where she accumulated 377 days in space between the two missions, the most for any US. woman at the time of her return to Earth." Another interesting fact from Peggy is that stated in @potter_record-setting_2018, In 2008, Whitson returned on Expedition 16 and became the first female commander of the space station. Also from @potter_record-setting_2018, Peggy announced her retirement on June 16, 2018. 

Sunita L Williams is a female astronaut selected by NASA in 1998 who has carried out two space missions Expeditions 14/15 and 32/33. @whiting_sunita_2016 Reported by NASA, now he is preparing for her third long-duration mission aboard the International Space Station. @whiting_sunita_2016
...
Furthermore, in figure (B), 106 people who come from civilian are MSP (Mission Specialist). Mission Specialists are working closely with the commander and pilot, are responsible for coordinating onboard operations involving crew activity planning. @nasa_selection Furthermore, 20 people were flight engineers, 7 were pilots, 3 were flight commander, and 5 were PSP (Payload Specialist). Payload Specialist is a professional in the physical or life sciences or a technician skilled in operating Shuttle-unique equipment. @nasa_selection What is interesting about this plot is that there are two people who are Space Tourist.

They are Anousheh Ansari, an American businesswoman and Lee So Yeon from South Korea. Reported by NASA, "American businesswoman Anousheh Ansari will fly with the Expedition 14 crew to the International Space Station as a spaceflight participant." @nasa_expedition She spent nine days on the station under a commercial agreement with the Russian Federal Space Agency (Roscosmos) and returned to Earth with the Expedition 13 crew. @nasa_expedition In that expedition, she was with Sunita Williams on board. @nasa_expedition

Meanwhile, Lee So Yeon is the first South Korean female astronaut to fly into space. Reported by NASA, she was selected from among 36,000 applicants to serve as her nation's first astronaut. @angelillo_international_2012 Based on @angelillo_international_2012 She flew on Soyuz TMA-12 to the International Space Station (ISS) on April 8, 2008, returning to Earth 10 days later.
