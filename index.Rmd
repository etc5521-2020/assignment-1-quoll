...
Since the first humans completed an orbital spaceflight in 1961 and stepped on the moon in 1969, space missions have been completed nearly 60 years (Corlett, Stavnickuk & Komarova, 2020). Meanwhile, space exploration is still technologically challenging and competitive. Therefore, this report mainly analyses the development of the world astronautic exploration with time from the first spaceflight launched and the other analyses include the trend in astronautic exploration, the tech of astronautic exploration development and trend of female astronauts developed. In the following sections, we will describe the data set and source of the data, and what is the data prepared for. The data description also includes how we transform and clean the raw data for analysis. Our statistical programming used for analysis is _R_ and _Rstudio_. 
