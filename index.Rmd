...
According to figure \@ref(fig:gender), while women have also appeared in space exploration, men have been the main force in this 49-year period. However, we cannot ignore the contribution of female astronaut in space exploration. Women has preformed essential work in astronautical area since 19th century (Jackson). The first women travelled  into space was in 1963, and the first American female astronaut appeared in 1983 (Jackson). Female astronauts also contribute to the exploration same as male astronauts. 
