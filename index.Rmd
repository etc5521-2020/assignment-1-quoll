...
*edit*:
- Instead of showing line graph, show bar plot
- Remove plotly graph as it is not value-adding

*edit: plot*
- Add plot: Instead of showing total amount of projects, show total hours spent in missions through time
  - Are there less space missions because astronauts are spending a longer time in space?
...
```{r network-graph, echo = FALSE, message = FALSE, fig.height = 8, fig.width = 12}
set.seed(10001)
