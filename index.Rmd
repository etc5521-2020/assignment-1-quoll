...
The `astronauts` data set, along with its cleaning script are hosted on this [GitHub Link](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-07-14/readme.md) and is collected from NASA, Roscosmos, and fun-made websites. The variables used for this analysis are included in the table below:
...
tibble(Variables, Class, Description) %>%
  datatable(class = 'cell-border stripe',
          ...
          selection="multiple",
          escape=FALSE,
          options = list(pageLength = 6, sDom  = '<"top">lrt<"bottom">ip'),
